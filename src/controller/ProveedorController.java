...
public class ProveedorController extends Controller {
     ...
     * proveedor, slo si existe localidad crea instancia de direccion y
     * persiste, solamente si el proveedor no existe asocia la direccion al
     * proveedor persiste proveedor
     */
     ...
     * proveedor, en funcion al ID seleccionado crea una instancia de direccion
     * del proveedor verifica que el DNI del proveedor es modificado, si lo es
     * setea el dni del proveedor instanciado edita direccion edita proveedor
     */
    public void btn_aceptarModificar() {
        ...
        if (vista.getJcb_localidad_direccion().getSelectedIndex() >= 0) {
            ...
            if (!proveedorModifocado) {
                ...
                } else //Verifica si existe el CUIT, si no existe se procede
                if (modelo.buscarProveedorCUIT(prov) == null) {
                    //Se modifica el CUIT
                    prov.setCuit(vista.getJtfCUIT().getText());
                    try {
     ...
     * proveedor, en funcion al ID seleccionado crea una instancia de direccion
     * del proveedor verifica que el proveedor tenga dreccion, si tiene
     * direccion se elimia la direccion del proveedor, elimina direccion elimina
     * proveedor
     */
    ...
    /**
     * Llena Jtable de proveedor crea una lista de proveedores existentes en la
     * base de datos.
     *
    ...
    /**
     * Verifica los eventos de click realizados en la tabla de proveedores si
     * cambia se completan los datos del proveedor
     *
